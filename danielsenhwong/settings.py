"""
Django settings for danielsenhwong project.
...
# add my own installed apps here, for readability
INSTALLED_APPS += (
...
ROOT_URLCONF = 'danielsenhwong.urls'

WSGI_APPLICATION = 'danielsenhwong.wsgi.application'
...
STATIC_ROOT = '/var/www/danielsenhwong/static/'
